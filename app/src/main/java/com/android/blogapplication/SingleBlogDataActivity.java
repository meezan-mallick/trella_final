...
public class SingleBlogDataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_single_blog_data);
        getWidgets();
        //Action bar
...
//        blog_img.setImageResource(i.getIntExtra("blogimage",0));
    ...
    private void getWidgets() {
        ...
        date_blogpost = findViewById(R.id.date_blogpost);
